    ...
    public partial class CreateAccountPage2 : Page
    {
               ...
               cs.CCV != null)
                {
                    ...
                    this.NavigationService.Navigate(new CreateAccountPage3(cs.FirstName, cs.LastName, cs.Email, cs.Phone, cs.DOB, cs.Country, cs.TownOrCity, cs.Nationality, cs.CustAddress, cs.PostalCd, cs.Username, cs.CustPassword, cs.CardType, cs.CardNo, cs.CardExpirationDate, cs.CardHolderName, cs.CCV));
                }
            }
        ...
        private void BackButton_Click(object sender, RoutedEventArgs e)
        {
            if (cs.CardType != null &&
                 ...
                 cs.CCV != null)
            {
                this.NavigationService.Navigate(new CreateAccountPage1(cs.FirstName, cs.LastName, cs.Email, cs.Phone, cs.DOB, cs.Country, cs.TownOrCity, cs.Nationality, cs.CustAddress, cs.PostalCd, cs.Username, cs.CustPassword, cs.CardType, cs.CardNo, cs.CardExpirationDate, cs.CardHolderName, cs.CCV)); //navigate to previous page and pass info for display
            }
            else
            {
                this.NavigationService.Navigate(new CreateAccountPage1(cs.FirstName, cs.LastName, cs.Email, cs.Phone, cs.DOB, cs.Country, cs.TownOrCity, cs.Nationality, cs.CustAddress, cs.PostalCd, cs.Username, cs.CustPassword));
            }
